...
<!-- initialized-at: 2026-07-05 13:10:33 +08:00 -->

# Codex Git Workflow

Initialization status: initialized
Project: LunTian
Repository root: D:/WebProjects/LunTian
Machine config: `
...
```
powershell
git -c safe.directory=D:/WebProjects/LunTian status --short --branch
```
...
```
powershell
git -c safe.directory=D:/WebProjects/LunTian push -u origin HEAD
```
